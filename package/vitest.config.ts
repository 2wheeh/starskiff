    ...
    projects: [
      {
        test: {
          name: 'unit',
          include: ['test/Instance.test.ts', 'test/smoke.test.ts', 'test/ports.test.ts', 'test/accounts.test.ts', 'test/extra-validator-stake.test.ts', 'test/images-manifest.test.ts', 'test/docker-runtime.test.ts'],
        },
      },
      {
        test: {
